...
Given previously defined `mylog` function, prints 'hello world' using with indentation level set to 2:
...
Creates a derived `mylog` function that draws colored timestamps in the end of messages:
